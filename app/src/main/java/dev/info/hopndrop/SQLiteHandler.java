...
public class SQLiteHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_LOGIN_TABLE = "CREATE TABLE " + TABLE_USER + "("
                ...
                + KEY_LASTNAME + " TEXT,"+ KEY_ADDRESS + " TEXT,"
                + KEY_CONTACTNUMBER + " TEXT,"+KEY_TOKEN + " TEXT,"
     ...
     * */
    public void addUser(String firstname,String lastname,String address,String contact_number,String token, String email, String uid, String created_at) {
        ...
        values.put(KEY_CONTACTNUMBER, contact_number); // Name
    ...
    public HashMap<String, String> getUserDetails() {
        ...
        if (cursor.getCount() > 0) {
            ...
            user.put("contact_number", cursor.getString(4));
